import PremiumTile from '../_components/PremiumTile';
import AddTransactionCTA from "../_components/AddTransactionCTA";
...
{/*
  FM: CTA below Brand START
*/}
<AddTransactionCTA />
{/* FM: CTA below Brand END */}
{/* $124 }} />
{/* FM: GRID TOP SPACER END */}
          <View style={styles.grid}>
  <PremiumTile label="Skan paragonu"        icon={<Feather name="camera"        size={24} color="#7C4DFF" />} onPress={() => router.push('/scan')} />
  <PremiumTile label="Do zapłaty"           icon={<Feather name="credit-card"   size={24} color="#7C4DFF" />} onPress={() => router.push('/bills')} />
  <PremiumTile label="Analizy"              icon={<Feather name="bar-chart-2"   size={24} color="#7C4DFF" />} onPress={() => router.push('/analytics')} />
  <PremiumTile label="Cele"                 icon={<Feather name="target"        size={24} color="#7C4DFF" />} onPress={() => router.push('/goals')} />
  <PremiumTile label="Budżety"              icon={<Feather name="pie-chart"     size={24} color="#7C4DFF" />} onPress={() => router.push('/budgets')} />
  <PremiumTile label="Raporty"              icon={<Feather name="file-text"     size={24} color="#7C4DFF" />} onPress={() => router.push('/reports')} />
  <PremiumTile label="Szybkie podsumowanie" icon={<Feather name="activity"      size={24} color="#7C4DFF" />} onPress={() => router.push('/quick-summary')} />
  <PremiumTile label="Inwestycje"           icon={<Feather name="trending-up"   size={24} color="#7C4DFF" />} onPress={() => router.push('/investments')} />
  <PremiumTile label="Podróże"              icon={<Feather name="map"           size={24} color="#7C4DFF" />} onPress={() => router.push('/travel')} />
</View>
        </ScrollView>
...
<View style={{ transform:[{ scale:1.5 }], marginTop:-16, alignSelf:'center' }}>
  ...
  <PremiumTile label="Kryptowaluty" icon={<MaterialCommunityIcons name="bitcoin"     size={24} color="#7C4DFF" />} onPress={() => router.push('/crypto')} />
  <PremiumTile label="Giełda"       icon={<Feather               name="trending-up" size={24} color="#7C4DFF" />} onPress={() => router.push('/stocks')} />
  <PremiumTile label="Giełda krypto" icon={<MaterialCommunityIcons name="swap-horizontal" size={24} color="#7C4DFF" />} onPress={() => router.push('/crypto-exchange')} />
  <PremiumTile label="Subskrypcje"  icon={<Feather               name="layers"       size={24} color="#7C4DFF" />} onPress={() => router.push('/subscriptions')} />
  <PremiumTile label="Podatki"      icon={<MaterialCommunityIcons name="file-document" size={24} color="#7C4DFF" />} onPress={() => router.push('/taxes')} />
  <PremiumTile label="Kursy Walut"  icon={<MaterialIcons         name="attach-money" size={24} color="#7C4DFF" />} onPress={() => router.push('/fx-rates')} />
</View>
        </ScrollView>
      </PagerView>
