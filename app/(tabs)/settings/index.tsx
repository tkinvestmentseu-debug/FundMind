...
import { useThemeMode, useColorTokens } from "../../../src/providers/theme";
...
function SegButton({
  ...
  return (
    ...
    >
      <ThemedText
        style={{ color: active ? t.tint : undefined, fontWeight: active ? "700" : "500" }}
      >
        {text}
      </ThemedText>
    </Pressable>
  ...
  return (
    <ThemedView style={{ flex: 1 }}>
      ...
      <Row
        label="Powiadomienia"
        right={
          <Switch value={settings.notifications} onValueChange={(v) => set("notifications", v)} />
        }
      />
      <Row
